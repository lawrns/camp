...
class OptionalAuthErrorBoundary extends React.Component<{ children: React.ReactNode }, { hasAuthError: boolean }> {
  ...
  static getDerivedStateFromError(error: Error) {
    ...
    if ((error instanceof Error ? error.message : String(error)).includes("useAuth must be used within") || (error instanceof Error ? error.message : String(error)).includes("AUTH ERROR")) {
