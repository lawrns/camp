        ...
        <CardHeader>
          <div className="flex items-center space-x-3">
            ...
            <div className="flex-1">
              ...
              <CardDescription>{getErrorDescription(errorCategory, (error instanceof Error ? error.message : String(error)))}</CardDescription>
            </div>
  ...
  return (
    <div className="flex items-center space-x-3 rounded-ds-lg border border-[var(--fl-color-danger-muted)] bg-red-50 spacing-3">
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="truncate text-tiny text-red-600">{context.error instanceof Error ? context.error.message : String(context.error)}</p>
      </div>
      {onRetry && (
