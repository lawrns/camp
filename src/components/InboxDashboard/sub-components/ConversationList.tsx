...
export const ConversationList: React.FC<ConversationListProps> = ({
  ...
  return (
    <div className="relative z-10 flex h-full min-h-0 flex-col border-r border-[var(--color-border)] bg-[var(--color-surface)]" style={{ width: 'var(--width-sidebar, 24rem)' }} data-testid="conversation-list-container" ref={containerRef}>
      {/* Filter bar */}
      <div className="border-b border-[var(--color-border)] spacing-4">
          ...
          {[
            ...
            <button
              ...
              className={`px-3 py-1 rounded-ds-md text-sm font-medium transition-colors ${activeFilter === filter.key
                  ...
                  : "bg-[var(--color-surface)] text-[var(--color-text)] hover:bg-[var(--color-background-muted)]"
                }`}
            >
              {filter.label}
            </button>
