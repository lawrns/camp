...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-ds-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
      ...
      size: {
        ...
        sm: "h-8 rounded-ds-md px-3 text-xs",
        lg: "h-10 rounded-ds-md px-8",
        icon: "h-9 w-9",
      },
    },
    defaultVariants: {
  ...
  ({ className, variant = "ghost", ...props }, ref) => {
    return (
      <Button
        ...
        variant={variant}
        className={cn(
          "border-white/20 bg-white/10 backdrop-blur-md backdrop-saturate-150 hover:bg-white/20",
          className
        )}
        {...props}
      />
...
export { Button, LoadingButton, GlassButton, buttonVariants };
