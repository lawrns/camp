...
const Progress = React.forwardRef<React.ElementRef<typeof ProgressPrimitive.Root>, ProgressProps>(
  (
    ...
    // FIXED: Clamp value between 0 and 100 to prevent Radix UI errors
    const clampedValue = value !== null && value !== undefined ? Math.max(0, Math.min(100, value)) : value;
    const progressValue = indeterminate ? null : clampedValue;
      ...
      <div className="w-full">
        ...
        >
          <ProgressPrimitive.Indicator
            ...
            style={{
              transform: indeterminate ? undefined : `translateX(-${100 - (clampedValue || 0)}%)`,
            }}
          >
...
const CircularProgress = React.forwardRef<HTMLDivElement, CircularProgressProps>(
  ({ value = 0, size = 48, strokeWidth = 4, showValue = false, label, variant = "default", className }, ref) => {
    // FIXED: Clamp value between 0 and 100 for circular progress
...
export { CircularProgress, Progress, progressIndicatorVariants, progressVariants };
