...
const separatorVariants = cva(
  ...
  "shrink-0",
  {
    variants: {
      ...
      variant: {
        default: "bg-[var(--ds-color-border)]",
        strong: "bg-[var(--ds-color-border-strong)]",
        subtle: "bg-[var(--ds-color-border-subtle)]",
        brand: "bg-[var(--ds-color-brand)]",
        gradient: "bg-gradient-to-r from-transparent via-[var(--ds-color-border)] to-transparent",
...
export { SectionSeparator, Separator, separatorVariants, SeparatorWithLabel };
