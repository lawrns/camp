...
const toastVariants = cva(
  // Base styles
  [
    "group pointer-events-auto relative flex w-full items-center justify-between space-x-[var(--fl-space-4)] overflow-hidden border p-[var(--fl-space-6)] pr-[var(--fl-space-8)] shadow-[var(--fl-shadow-lg)] transition-all",
...
const ToastAction = React.forwardRef<React.ElementRef<typeof ToastPrimitives.Action>, ToastActionProps>(
  ({ className, ...props }, ref) => (
    <ToastPrimitives.Action
      ref={ref}
      className={cn(
        "inline-flex h-8 shrink-0 items-center justify-center border border-[var(--fl-color-border)] bg-transparent px-[var(--fl-space-3)] font-[var(--fl-font-weight-medium)] text-[var(--fl-font-size-sm)] ring-offset-background transition-colors",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-[var(--fl-space-2)] top-[var(--fl-space-2)] p-[var(--fl-space-1)] text-[var(--fl-color-text-muted)] opacity-0 transition-opacity",
