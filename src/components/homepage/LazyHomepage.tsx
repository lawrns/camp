...
const HomepageLoading = () => (
  <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
    <div className="text-center">
      ...
      <div className="text-foreground text-lg font-semibold">Loading Campfire...</div>
      <div className="mt-2 text-sm text-[var(--fl-color-text-muted)]">Preparing your workspace...</div>
    </div>
  </div>
);
...
const FeaturesSection = dynamic(() => import("./sections/FeaturesSection"), {
  loading: () => <div className="h-96 animate-pulse bg-[var(--fl-color-background-subtle)]" />,
  ssr: false,
});
...
const CTASection = dynamic(() => import("./sections/CTASection"), {
  loading: () => <div className="h-48 animate-pulse bg-[var(--fl-color-info-subtle)]" />,
  ssr: false,
});

const AnimatedNavigation = dynamic(() => import("./sections/AnimatedNavigation"), {
  loading: () => (
    <nav className="bg-background/80 fixed top-0 z-50 w-full border-b border-[var(--fl-color-border)] backdrop-blur-sm">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between py-4">
          <div className="text-lg font-bold text-blue-600">Campfire</div>
          <div className="flex gap-3">
            <div className="h-8 w-16 animate-pulse rounded bg-gray-200" />
            <div className="bg-primary h-8 w-16 animate-pulse rounded" />
          </div>
        </div>
      </div>
    </nav>
  ...
  return (
    <div className="min-h-screen">
      <Suspense fallback={<HomepageLoading />}>
        ...
        <Suspense fallback={<div className="h-96 animate-pulse bg-[var(--fl-color-background-subtle)]" />}>
          <FeaturesSection />
        </Suspense>
        ...
        <Suspense fallback={<div className="h-48 animate-pulse bg-[var(--fl-color-info-subtle)]" />}>
          <CTASection />
        </Suspense>
      </Suspense>
    </div>
