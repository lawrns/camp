...
export const RealtimeMetricsDashboard: React.FC = () => {
  ...
  const refreshMetrics = async () => {
    try {
      const newSummary = await RealtimeMonitor.getMetricsSummary();
      const newPerformance = await RealtimeMonitor.getPerformanceMetrics();
      const newChannels = await RealtimeMonitor.getAllMetrics();
