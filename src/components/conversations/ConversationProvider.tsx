...
export const ConversationProvider: React.FC<ConversationProviderProps> = ({ children, organizationId }) => {
  ...
  const loadConversations = useCallback(async () => {
    ...
    try {
      ...
      dispatch({
        type: "SET_ERROR",
        payload: error instanceof Error ? (error instanceof Error ? error.message : String(error)) : "Failed to load conversations",
      });
    }
  ...
  const loadConversation = useCallback(async (id: number) => {
    ...
    try {
      ...
      dispatch({
        type: "SET_ERROR",
        payload: error instanceof Error ? (error instanceof Error ? error.message : String(error)) : "Failed to load conversation",
      });
    }
  }, []);
  ...
  const loadMessages = useCallback(async (conversationId: string) => {
    ...
    try {
      ...
      dispatch({
        type: "SET_ERROR",
        payload: error instanceof Error ? (error instanceof Error ? error.message : String(error)) : "Failed to load messages",
      });
    }
  }, []);
  ...
  const sendMessage = useCallback(
    async (conversationId: string, content: string, attachments?: string[]): Promise<Message> => {
      try {
        ...
        dispatch({
          type: "SET_ERROR",
          payload: error instanceof Error ? (error instanceof Error ? error.message : String(error)) : "Failed to send message",
        });
        throw error;
      }
    },
  ...
  const updateMessage = useCallback(async (messageId: string, content: string) => {
    try {
      ...
      dispatch({
        type: "SET_ERROR",
        payload: error instanceof Error ? (error instanceof Error ? error.message : String(error)) : "Failed to update message",
      });
      throw error;
    }
  }, []);
  ...
  const deleteMessage = useCallback(async (messageId: string) => {
    try {
      ...
      dispatch({
        type: "SET_ERROR",
        payload: error instanceof Error ? (error instanceof Error ? error.message : String(error)) : "Failed to delete message",
      });
      throw error;
    }
  }, []);
  ...
  const updateConversationStatus = useCallback(async (conversationId: string, status: Conversation["status"]) => {
    try {
      ...
      dispatch({
        type: "SET_ERROR",
        payload: error instanceof Error ? (error instanceof Error ? error.message : String(error)) : "Failed to update conversation status",
      });
      throw error;
    }
  }, []);
  ...
  const updateConversationPriority = useCallback(async (conversationId: string, priority: Conversation["priority"]) => {
    try {
      ...
      dispatch({
        type: "SET_ERROR",
        payload: error instanceof Error ? (error instanceof Error ? error.message : String(error)) : "Failed to update conversation priority",
      });
      throw error;
    }
  }, []);
  ...
  const assignConversation = useCallback(async (conversationId: string, agentId: string) => {
    try {
      ...
      dispatch({
        type: "SET_ERROR",
        payload: error instanceof Error ? (error instanceof Error ? error.message : String(error)) : "Failed to assign conversation",
      });
      throw error;
    }
  }, []);
  ...
  const addConversationTags = useCallback(async (conversationId: string, tags: string[]) => {
    try {
      ...
      dispatch({
        type: "SET_ERROR",
        payload: error instanceof Error ? (error instanceof Error ? error.message : String(error)) : "Failed to add tags",
      });
      throw error;
    }
  }, []);
  ...
  const removeConversationTags = useCallback(async (conversationId: string, tags: string[]) => {
    try {
      ...
      dispatch({
        type: "SET_ERROR",
        payload: error instanceof Error ? (error instanceof Error ? error.message : String(error)) : "Failed to remove tags",
      });
      throw error;
    }
  }, []);
  ...
  const createConversation = useCallback(
    async (customerEmail: string, initialMessage?: string): Promise<Conversation> => {
      try {
        ...
        dispatch({
          type: "SET_ERROR",
          payload: error instanceof Error ? (error instanceof Error ? error.message : String(error)) : "Failed to create conversation",
        });
        throw error;
      }
    },
