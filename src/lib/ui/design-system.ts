...
export const ds = {
  ...
  components: {
    ...
    // Badge patterns
    badge: "inline-flex items-center px-2.5 py-0.5 rounded-ds-full text-xs font-medium",
    badgeSuccess: "inline-flex items-center px-2.5 py-0.5 rounded-ds-full text-xs font-medium bg-green-100 text-green-800",
    badgeWarning: "inline-flex items-center px-2.5 py-0.5 rounded-ds-full text-xs font-medium bg-yellow-100 text-yellow-800",
    badgeError: "inline-flex items-center px-2.5 py-0.5 rounded-ds-full text-xs font-medium bg-red-100 text-red-800",
    ...
    notification: "bg-white rounded-ds-lg border border-gray-200 shadow-lg spacing-4",
