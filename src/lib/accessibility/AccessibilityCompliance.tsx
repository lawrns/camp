  ...
  return (
    <div className="space-y-1">
      ...
      <input
        ...
        id={inputId}
        required={required}
        className={`block min-h-[44px] w-full rounded-ds-md border px-3 py-2 text-base shadow-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 ${error ? "border-red-300" : "border-gray-300"} ${className} `}
