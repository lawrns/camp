  ...
  try {
    ...
    if (!response.ok) {
      ...
      toast.update({
        ...
        variant: "error",
        title: "Error",
        description: options?.errorMessage || (error instanceof Error ? error.message : String(error)) || "Request failed",
        persist: false,
        duration: 5000,
      });
    ...
    toast.update({
      ...
      variant: "error",
      title: "Error",
      description: options?.errorMessage || (error instanceof Error ? (error instanceof Error ? error.message : String(error)) : "An unexpected error occurred"),
      persist: false,
      duration: 5000,
    });
