...
test.describe('Complete E2E Flow', () => {
  ...
  test('should test tRPC endpoints directly', async ({ page }) => {
    ...
    for (const endpoint of endpoints) {
      ...
      const response = await page.request.get(`http://localhost:3000${endpoint}?batch=1&input=%7B%220%22%3A%7B%22json%22%3A%7B%22organizationId%22%3A%22b5e80170-004c-4e82-a88c-3e2166b169dd%22%7D%7D%7D`);
