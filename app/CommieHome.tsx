...
// Beautiful Homepage with animations - imported from commie
const BeautifulHomepage = dynamic(() => import("../commie/components/homepage/Homepage"), {
    loading: () => (
...
/**
 * Commie Homepage Component
 * 
 * This component imports and renders the enhanced homepage from the commie directory.
 * It includes the BeautifulHomepage component and the custom widget script.
 */
export default function CommieHome() {
    return (
