-- 🚨 URGENT FIX: RLS Policies + Laurence Account
...
DROP POLICY IF EXISTS "conversation_memory_service_role_access" ON conversation_memory;
DROP POLICY IF EXISTS "conversation_memory_authenticated_access" ON conversation_memory;
...
DROP POLICY IF EXISTS "ai_handover_sessions_service_role_access" ON ai_handover_sessions;
DROP POLICY IF EXISTS "ai_handover_sessions_authenticated_access" ON ai_handover_sessions;
...
DROP POLICY IF EXISTS "knowledge_documents_service_role_access" ON knowledge_documents;
DROP POLICY IF EXISTS "knowledge_documents_authenticated_access" ON knowledge_documents;
...
DROP POLICY IF EXISTS "campfire_handoffs_service_role_access" ON campfire_handoffs;
DROP POLICY IF EXISTS "campfire_handoffs_authenticated_access" ON campfire_handoffs;
...
DROP POLICY IF EXISTS "typing_indicators_service_role_access" ON typing_indicators;
