...
-- Create a unique index instead of constraint for typing indicators
CREATE UNIQUE INDEX IF NOT EXISTS idx_typing_indicators_unique 
ON typing_indicators (conversation_id, user_id, visitor_id) 
WHERE user_id IS NOT NULL OR visitor_id IS NOT NULL;
