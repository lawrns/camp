...
const cardVariants = cva(
  ...
  [
    ...
    "duration- [var(--fl-duration-200) ] ease- [var(--fl-ease-out) ] transition-all",
  ],
  {
    variants: {
      variant: {
      ...
      padding: {
        none: "p-0",
        sm: "p-[var(--fl-space-4)]",
        default: "p-[var(--fl-space-6)]",
        lg: "p-[var(--fl-space-8)]",
        xl: "p-[var(--fl-space-10)]",
      },
      interactive: {
...
>(({ className, padding = "default", ...props }, ref) => {
  const paddingClasses = {
    none: "p-0",
    sm: "px-[var(--fl-space-4)] py-[var(--fl-space-3)]",
    default: "px-[var(--fl-space-6)] py-[var(--fl-space-4)]",
    lg: "px-[var(--fl-space-8)] py-[var(--fl-space-6)]",
  };

  return (
    <div
      ref={ref}
      className={cn("flex flex-col space-y-[var(--fl-space-2)]", paddingClasses[padding], className)}
      {...props}
    />
  );
});
...
>(({ className, as: Comp = "h3", size = "default", ...props }, ref) => {
  const sizeClasses = {
    sm: "text-[var(--fl-font-size-base)] font-[var(--fl-font-weight-medium)]",
    default: "text-[var(--fl-font-size-lg)] font-[var(--fl-font-weight-semibold)]",
    lg: "text-[var(--fl-font-size-xl)] font-[var(--fl-font-weight-semibold)]",
    xl: "text-[var(--fl-font-size-2xl)] font-[var(--fl-font-weight-bold)]",
  };
...
>(({ className, size = "default", ...props }, ref) => {
  ...
  return (
    <p
      ref={ref}
      className={cn(
        "leading-[var(--fl-line-height-relaxed)] text-[var(--fl-color-text-muted)]",
        sizeClasses[size],
        className
      )}
      {...props}
...
>(({ className, padding = "default", ...props }, ref) => {
  const paddingClasses = {
    none: "p-0",
    sm: "px-[var(--fl-space-4)] pb-[var(--fl-space-3)]",
    default: "px-[var(--fl-space-6)] pb-[var(--fl-space-4)]",
    lg: "px-[var(--fl-space-8)] pb-[var(--fl-space-6)]",
  };
...
>(({ title, value, description, icon, trend, className, ...props }, ref) => {
  ...
  return (
    <Card ref={ref} className={cn("", className)} {...props}>
      <CardContent className="p-[var(--fl-space-6)]">
        <div className="flex items-center justify-between">
          <div className="space-y-[var(--fl-space-2)]">
            <p className="font-[var(--fl-font-weight-medium)] text-[var(--fl-color-text-muted)] text-[var(--fl-font-size-sm)]">
              {title}
            </p>
            <p className="font-[var(--fl-font-weight-bold)] text-[var(--fl-color-text)] text-[var(--fl-font-size-2xl)]">
              {value}
            </p>
            {description && (
              <p className="text-[var(--fl-color-text-subtle)] text-[var(--fl-font-size-xs)]">{description}</p>
            )}
          </div>
        ...
        {trend && (
          <div
            className={cn(
              "mt-[var(--fl-space-2)] flex items-center gap-[var(--fl-space-1)] text-[var(--fl-font-size-xs)]",
