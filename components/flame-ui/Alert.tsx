...
const alertVariants = cva(
  // Base styles
  [
    "relative w-full rounded-[var(--fl-rounded-ds-lg)] p-[var(--fl-space-4)]",
    "border",
        ...
        {dismissible && (
          <button
            ...
            className={cn(
              ...
              "rounded-[var(--fl-rounded-ds-sm)]",
              "p-[var(--fl-space-1)]",
              "opacity-70 hover:opacity-100",
              "transition-opacity duration-\ [var(--fl-duration-150)\]",
...
const AlertDescription = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn("text-[var(--fl-font-size-sm)] [&_p]:leading-relaxed", className)} {...props} />
  )
);
