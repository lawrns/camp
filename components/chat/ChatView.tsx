...
export function ChatView({ className }: ChatViewProps) {
  ...
  const handleCreateTicket = (priority: "low" | "medium" | "high" | "urgent") => {
    ...
    createTicket(selectedConversationId, `Support Request - ${selectedConversation.subject}`, priority);
      ...
      <div className="flex-1 space-y-3 overflow-y-auto spacing-3">
        <OptimizedAnimatePresence>
          {isEscalated && (
            ...
            >
              <Alert variant="default" className="mx-4 mt-2 border-amber-200 bg-amber-500/10 text-amber-600">
