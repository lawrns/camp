  ...
  const EmptyState = () => (
    <div className="flex h-full flex-col items-center justify-center p-8">
      <div className="text-center max-w-sm">
        ...
        <h3 className="mb-3 text-lg font-semibold text-gray-900">No messages yet</h3>
        <p className="text-sm text-gray-500 leading-relaxed">
          {selectedConversation?.customerName
            ? `Start the conversation with ${selectedConversation.customerName} by sending a message below.`
            : "This conversation is ready for your first message."
          }
        </p>
      </div>
    </div>
