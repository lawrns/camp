...
export function DefinitiveWidget({ organizationId, onClose }: DefinitiveWidgetProps) {
  ...
  useEffect(() => {
    ...
    openWidget(); // This will trigger conversation initialization
  }, []); // Remove openWidget dependency to prevent infinite loop
  ...
  return (
    <div
      className="fixed bottom-4 right-4 w-96 h-[600px] bg-background border rounded-ds-lg shadow-2xl flex flex-col z-[9999] overflow-hidden"
        ...
        <div className="flex justify-between items-center">
          ...
          {widgetState.error && (
            <div className="text-red-600 font-medium">
              Error: {widgetState.error.slice(0, 30)}...
            </div>
          )}
        </div>
      </div>
