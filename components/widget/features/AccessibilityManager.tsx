...
export const accessibilityClasses = {
  ...
  focusVisible:
    "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ds-color-primary-500 focus-visible:ring-offset-2",
  ...
  // Skip link styles
  skipLink: "absolute -top-10 left-6 bg-ds-color-primary-600 text-white px-4 py-2 ds-rounded-ds-md z-50 focus:top-6 transition-all",
};
