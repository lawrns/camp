...
function GlobalErrorFallback({ error, resetErrorBoundary }: GlobalErrorFallbackProps) {
  ...
  const isAnimationError =
    ...
    error.message.includes("OptimizedMotion") ||
    error.message.includes("AnimatePresence");

  const isNetworkError =
    error.message.includes("fetch") || error.message.includes("Network") || error.message.includes("ERR_NETWORK");
