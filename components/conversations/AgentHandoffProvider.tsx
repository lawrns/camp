...
export const AgentHandoffProvider: React.FC<AgentHandoffProviderProps> = ({ children, organizationId }) => {
  ...
  const loadAgents = useCallback(async () => {
    ...
    try {
      ...
      dispatch({
        type: "SET_ERROR",
        payload: error instanceof Error ? error.message : "Failed to load agents",
      });
    }
  }, [organizationId]);
  ...
  const loadActiveHandoffs = useCallback(async () => {
    ...
    try {
      ...
      dispatch({
        type: "SET_ERROR",
        payload: error instanceof Error ? error.message : "Failed to load handoffs",
      });
    }
  }, [organizationId]);
  ...
  const requestHandoff = useCallback(
    async (conversationId: string, reason: string, priority: HandoffRequest["priority"]): Promise<HandoffRequest> => {
      ...
      try {
        ...
        dispatch({
          type: "SET_ERROR",
          payload: error instanceof Error ? error.message : "Failed to request handoff",
        });
        throw error;
      }
    },
  ...
  const acceptHandoff = useCallback(async (handoffId: string) => {
    try {
      ...
      dispatch({
        type: "SET_ERROR",
        payload: error instanceof Error ? error.message : "Failed to accept handoff",
      });
      throw error;
    }
  }, []);
  ...
  const declineHandoff = useCallback(async (handoffId: string, reason?: string) => {
    try {
      ...
      dispatch({
        type: "SET_ERROR",
        payload: error instanceof Error ? error.message : "Failed to decline handoff",
      });
      throw error;
    }
  }, []);
  ...
  const completeHandoff = useCallback(async (handoffId: string) => {
    try {
      ...
      dispatch({
        type: "SET_ERROR",
        payload: error instanceof Error ? error.message : "Failed to complete handoff",
      });
      throw error;
    }
  }, []);
  ...
  const cancelHandoff = useCallback(async (handoffId: string) => {
    try {
      ...
      dispatch({
        type: "SET_ERROR",
        payload: error instanceof Error ? error.message : "Failed to cancel handoff",
      });
      throw error;
    }
  }, []);
  ...
  const updateAgentStatus = useCallback(async (agentId: string, status: Agent["status"]) => {
    try {
      ...
      dispatch({
        type: "SET_ERROR",
        payload: error instanceof Error ? error.message : "Failed to update agent status",
      });
      throw error;
    }
  }, []);
